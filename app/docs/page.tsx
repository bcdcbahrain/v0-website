  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        ...
        description: "Ace your Dawah skills with Prophetic Character & Resilience.",
        category: "Beginner",
         status: "Coming Soon",
        type: "PDF from PPT",
        icon: Eye,
      ...
      },
     {
      ...
      },
      {
        ...
        description: "A Comprehensive Guide to Self Care before others and its Rationale",
        category: "Intermediate",
        status: "Coming Soon",
        type: "PDF Guide",
        icon: Users,
		...
		{
        title: "The Architecture of Dawah Psychology",
        description: "Examining the Prophetic techniques of Dawah",
        category: "Intermediate",
        status: "Coming Soon",
        type: "PDF Guide",
        icon: BookOpenCheck,
